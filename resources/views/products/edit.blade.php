...
@section('content')
    <div class="container mt-5">
        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('slug') is-invalid @enderror" name="slug"
                        id="slug" value="{{ old('slug', $product->slug) }}" required>
                    @error('slug')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="file" class="form-control @error('main_image') is-invalid @enderror" name="main_image"
                        id="main_image" onchange="previewMainImage()">
                    @error('main_image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <!-- Main Image Preview -->
                    <div id="main_image_preview" class="mt-3">
                        @if ($product->main_image)
                            <img src="{{ asset('storage/' . $product->main_image) }}" class="img-thumbnail"
            ...
            <div class="row">
                <!-- Multiple Images -->
                <div id="multiple_images_preview" class="mt-3 row">
                    @if($product->multiple_images)
                        ...
                        @foreach ($images as $image)
                            <div class="col-md-4 mb-3 position-relative">
                                <img src="{{ asset('storage/' . $image) }}" class="img-thumbnail" style="max-width: 100%;">
                            </div>
                        @endforeach
                    @else
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('minimum_dispatch_quantity') is-invalid @enderror"
                        name="minimum_dispatch_quantity" id="minimum_dispatch_quantity"
                        value="{{ old('minimum_dispatch_quantity', $product->minimum_dispatch_quantity) }}" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('minimum_order_quantity') is-invalid @enderror"
                        name="minimum_order_quantity" id="minimum_order_quantity"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('send_at_least') is-invalid @enderror"
                        name="send_at_least" id="send_at_least"
                        value="{{ old('send_at_least', $product->send_at_least) }}" required>
                    @error('send_at_least')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('minimum_shipment_qty') is-invalid @enderror"
                        name="minimum_shipment_qty" id="minimum_shipment_qty"
                        value="{{ old('minimum_shipment_qty', $product->minimum_shipment_qty) }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('bulk_order_threshold') is-invalid @enderror"
                        name="bulk_order_threshold" id="bulk_order_threshold"
                        value="{{ old('bulk_order_threshold', $product->bulk_order_threshold) }}" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('minimum_pack_quantity') is-invalid @enderror"
                        name="minimum_pack_quantity" id="minimum_pack_quantity"
                        value="{{ old('minimum_pack_quantity', $product->minimum_pack_quantity) }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('required_stock_for_order') is-invalid @enderror"
                        name="required_stock_for_order" id="required_stock_for_order"
                        value="{{ old('required_stock_for_order', $product->required_stock_for_order) }}" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('order_min_quantity') is-invalid @enderror"
                        name="order_min_quantity" id="order_min_quantity"
                        value="{{ old('order_min_quantity', $product->order_min_quantity) }}" required>
    ...
    function previewMultipleImages() {
        ...
        Array.from(multipleImagesInput.files).forEach((file, index) => {
            ...
            reader.onload = function(e) {
                ...
                removeButton.onclick = function() {
                    // Remove specific image from the preview
                    imgContainer.remove();

                    // Remove image from input list
                    const dataTransfer = new DataTransfer();
                    Array.from(multipleImagesInput.files).forEach((file, fileIndex) => {
                        if (fileIndex !== index) {
